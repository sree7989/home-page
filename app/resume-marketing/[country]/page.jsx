...
const metaData = {
  ...
  germany: {
    title:
      "Germany Resume Marketing Services for Jobs IT Careers and Work Visa Opportunities",
    keywords:
      " Germany resume marketing, German job market, IT resume Germany, professional resumes Germany, Germany LinkedIn optimization, job application support Germany, ATS resume Germany, career growth Germany, German employers, Germany work permit, Germany Blue Card, Germany PR visa, Germany resume distribution, Germany job search, Germany executive resume, Germany skill-based resumes, Germany resume branding, Germany application assistance, Best Visa Immigration Consultants, VJC Overseas",
  },
  usa: {
    title:
      " USA Resume Marketing Services ATS Optimized Resumes for US Job Market",
    keywords:
      "USA resume marketing, Resume marketing Services, US job market, ATS compliant resumes, resume optimization, USA IT resume services, USA LinkedIn optimization, USA professional resume writing, USA job application support, USA career growth, US employers, USA work permit, H1B visa USA, USA PR visa, USA resume distribution, USA job search, USA executive resume, USA skill based resumes, USA resume branding, Best Visa Immigration Consultants, VJC Overseas",
  },
  australia: {
    title:
  ...
  ireland: {
    title:
      "Ireland Resume Marketing Services Professional CV Writing and Job Application Support",
    keywords:
  ...
  dubai: {
    title:
      "Dubai Resume Marketing Services Professional CV Writing for UAE Job Market",
    keywords:
  ...
  newzealand: {
    title:
      "New Zealand Resume Marketing Services Professional CV Writing for Job and Visa Growth",
    keywords:
      "New Zealand resume marketing, New Zealand resume services, ATS New Zealand resumes, New Zealand resume writing, New Zealand LinkedIn optimization, New Zealand job opportunities, New Zealand career services, New Zealand work visa, New Zealand skilled migration, New Zealand resume distribution, New Zealand executive CV, New Zealand skill based resumes, New Zealand resume branding, New Zealand employers, New Zealand professional CV, New Zealand career growth, NZ work visa jobs, NZ job market, Best Visa Immigration Consultants, VJC Overseas",
  },
  malaysia: {
    title:
  ...
  poland: {
    title:
      "Poland Resume Marketing Services Professional CV Writing for Career Opportunities",
    keywords:
...
export async function generateMetadata({ params }) {
  ...
  return {
    title:
      data?.title ||
      "Resume Marketing – Boost Your Career Opportunities | VJC Career Services",
    description:
      data?.description ||
      "Get expert guidance to market your resume effectively with VJC Career Services. Improve your visibility, attract top employers, and land your dream job with a professionally crafted resume.",
    keywords:
      data?.keywords ||
      "resume marketing, professional resume services, CV writing, LinkedIn optimization, career growth, job application assistance, resume tips, professional branding, interview preparation, career consultancy, job search services",
  };
}
