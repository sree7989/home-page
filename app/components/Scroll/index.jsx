    ...
    <section className="w-full bg-white pt-2 pb-4 md:pt-3 md:pb-5 -mt-3 md:-mt-5">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 pt-0">
        <div className="grid md:grid-cols-2 gap-4 md:gap-6 items-center">
          ...
          {/* RIGHT CONTENT */}
          <div>
            <p className="text-gray-700 text-base sm:text-lg md:text-xl font-medium leading-relaxed max-w-xl md:-ml-6">
      ...
      <div className="w-full mt-4 md:mt-6">
        <img
          ...
          alt="Global People"
          className="w-full object-cover grayscale h-[220px] sm:h-[300px] md:h-auto"
        />
      </div>
