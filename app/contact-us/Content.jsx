...
>
        ...
        >
          ...
          <p className="text-lg md:text-xl">
            Have questions or need guidance? Our team is here to help — reach out and we’ll get back to you with the right support.
          </p>
        </motion.div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 -mt-20 z-20 relative pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-md border text-center px-3 py-5 flex flex-col items-center">
            ...
            <a href="tel:+919160449000" className="text-blue-600 font-bold hover:underline text-sm">
              +91 9160449000
            </a>
          </motion.div>
          ...
          {/* Website */}
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-md border text-center px-3 py-5 flex flex-col items-center">
            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 text-xl mb-3">
              <FaGlobe />
            </div>
            <h3 className="text-base font-bold mb-1">Visit Website</h3>
            <p className="text-gray-600 mb-2 text-sm font-medium">Explore our services & resources</p>
            <a href="https://www.vjcoverseas.com/" target="_blank" className="text-blue-600 font-bold hover:underline text-sm">
              Go to Website
            </a>
          </motion.div>
          ...
          {/* Email */}
          <motion.div whileHover={{ scale: 1.05 }} className="bg-white shadow-md border text-center px-3 py-5 flex flex-col items-center">
            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-red-100 text-red-600 text-xl mb-3">
              <FaEnvelope />
            </div>
            <h3 className="text-base font-bold mb-1">Email Us</h3>
            <p className="text-gray-600 mb-2 text-sm font-medium">Get detailed assistance via email</p>
            <a href="mailto:info@vjcoverseas.com" className="text-blue-600 font-bold hover:underline text-sm">
