...
const metaData = {
  ...
  germany: {
    title:
      "Germany Investor Visa Residency by Investment Business Startup and Company Formation",
    keywords:
  ...
  uae: {
    title:
      "UAE Investor Visa Golden Residency by AED 2 Million Real Estate or Business Investment Route",
    keywords:
  ...
  portugal: {
    title:
      "Portugal Investor Visa Golden Visa Business and Fund Investment for Residency Permit",
    keywords:
  ...
  austria: {
    title:
      "Austria Business Investor Visa Residency Route with Investment Accommodation Health Insurance and German A1",
    keywords:
